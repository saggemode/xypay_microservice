...
public class UserProfile {
    ...
    public LocalDateTime getPhoneVerificationTokenExpiry() { return phoneVerificationTokenExpiry; }
    public void setPhoneVerificationTokenExpiry(LocalDateTime phoneVerificationTokenExpiry) { this.phoneVerificationTokenExpiry = phoneVerificationTokenExpiry; }
