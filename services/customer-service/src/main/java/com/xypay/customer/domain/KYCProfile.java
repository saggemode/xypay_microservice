...
public class KYCProfile {
    ...
    public LocalDateTime getLastUpgradeCheck() { return lastUpgradeCheck; }
    public void setLastUpgradeCheck(LocalDateTime lastUpgradeCheck) { this.lastUpgradeCheck = lastUpgradeCheck; }
    
    public Integer getUpgradeEligibilityScore() { return upgradeEligibilityScore; }
    public void setUpgradeEligibilityScore(Integer upgradeEligibilityScore) { this.upgradeEligibilityScore = upgradeEligibilityScore; }
    
    public Boolean getUpgradeRequested() { return upgradeRequested; }
    public void setUpgradeRequested(Boolean upgradeRequested) { this.upgradeRequested = upgradeRequested; }
    
    public LocalDateTime getUpgradeRequestDate() { return upgradeRequestDate; }
    public void setUpgradeRequestDate(LocalDateTime upgradeRequestDate) { this.upgradeRequestDate = upgradeRequestDate; }
    
    public GovtIdType getGovtIdType() { return govtIdType; }
    public void setGovtIdType(GovtIdType govtIdType) { this.govtIdType = govtIdType; }
