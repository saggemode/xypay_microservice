...
public class Notification {
    ...
    public Notification(Long recipientId, String title, String message, NotificationType type) {
    ...
    public Long getBankTransferId() { return bankTransferId; }
    public void setBankTransferId(Long bankTransferId) { this.bankTransferId = bankTransferId; }
    ...
    public Long getVirtualCardId() { return virtualCardId; }
    public void setVirtualCardId(Long virtualCardId) { this.virtualCardId = virtualCardId; }
    ...
    public JsonNode getExtraData() { return extraData; }
    public void setExtraData(JsonNode extraData) { this.extraData = extraData; }
