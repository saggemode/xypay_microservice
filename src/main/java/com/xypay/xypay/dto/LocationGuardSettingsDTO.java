...
@Data
public class LocationGuardSettingsDTO {
    private UUID id;
    ...
    private String allowedStates = "[]"; // JSON array of allowed states
    ...
    private String function; // ENABLE_LOCATION_GUARD, DISABLE_LOCATION_GUARD, UPDATE_STATES
