...
@Data
public class NightGuardSettingsDTO {
    private UUID id;
    ...
    @NotNull(message = "Primary method is required")
    private String primaryMethod = "face"; // face, 2fa, pin, biometric
    
    @NotNull(message = "Fallback method is required")
    private String fallbackMethod = "2fa"; // face, 2fa, pin, biometric
    
    @NotNull(message = "Applies to is required")
    private String appliesTo = "app_only"; // app_only, web_only, all_channels
    ...
    private String function; // ENABLE_NIGHT_GUARD, DISABLE_NIGHT_GUARD, UPDATE_SETTINGS
